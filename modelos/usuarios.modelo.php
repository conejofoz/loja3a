...
class ModeloUsuarios {
    ...
    static public function mdlActualizarPerfil_Professor($tabla, $datos) {
    ...
    static public function mdlActualizarPerfil($tabla, $datos) {
        ...
        try {
            ...
            //$stmt->close();
            //$stmt = null;
            return "Aconteceu un error:-> " . $e->getMessage();
        } finally {
            //$stmt->close();
            $stmt = null;
        }
    ...
    static public function mdlAgregarDeseo($tabla, $datos) {
        $stmt = Conexion::conectar()->prepare("INSERT INTO "
                . "$tabla (id_usuario, id_producto) VALUES(:id_usuario, :id_producto)");
    ...
    /*=========================================================
     * ELIMINAR COMENTARIOS DO USUARIO
     =========================================================*/
